...
export function ChatInterface() {
  ...
  useKeyboardShortcuts({ onSend: handleSend, inputValue })
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen pt-16 pb-4 px-4">
      ...
      <div className="w-full max-w-4xl relative">
        <div className="flex flex-row items-center mb-2">
          ...
          <motion.p
            className="text-muted-foreground text-sm font-light z-10"
            animate={{
              y: isFocused ? 50 : 0,
              opacity: isFocused ? 0 : 100,
              filter: isFocused ? "blur(4px)" : "blur(0px)",
